...
class BatchProcessor:
    ...
    def __init__(self):
        ...
        self.moderation_service = None  # Will be initialized lazily
    ...
    def _process_single_item(
        ...
        try:
            ...
            # Process with AI
            moderation_service = self._get_moderation_service()
